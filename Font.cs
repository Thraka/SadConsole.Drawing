...
namespace SadConsole
{
    ...
    public class FontMaster
    {
        ...
        public FontMaster(Image fontImage, int glyphWidth, int glyphHeight, int totalColumns = 16, int glyphPadding = 0)
        {
            Image = fontImage;
...
#region Methods
        ...
        public static FontMaster LoadFont(string font)
        {
            ...
            if (DefaultFont == null)
                DefaultFont = masterFont.GetFont(Font.FontSizes.One);
